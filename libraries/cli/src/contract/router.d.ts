...
export declare const contract: {
   accounts: {
      ...
      update: import("@orpc/contract").ContractProcedureBuilderWithInputOutput<
         ...
         Record<never, never>
      >;
      remove: import("@orpc/contract").ContractProcedureBuilderWithInputOutput<
         z.ZodObject<
            {
               id: z.ZodString;
            },
   ...
   transactions: {
         ...
         z.ZodObject<
            {
               ...
               >;
               bankAccountId: z.ZodOptional<
                  z.ZodOptional<z.ZodNullable<z.ZodString>>
               >;
               destinationBankAccountId: z.ZodOptional<
                  z.ZodOptional<z.ZodNullable<z.ZodString>>
               >;
               creditCardId: z.ZodOptional<
                  z.ZodOptional<z.ZodNullable<z.ZodString>>
               >;
               categoryId: z.ZodOptional<
                  z.ZodOptional<z.ZodNullable<z.ZodString>>
               >;
               contactId: z.ZodOptional<
                  z.ZodOptional<z.ZodNullable<z.ZodString>>
               >;
               paymentMethod: z.ZodOptional<
                  z.ZodOptional<
      ...
      remove: import("@orpc/contract").ContractProcedureBuilderWithInputOutput<
         ...
         Record<never, never>
      >;
      summary: import("@orpc/contract").ContractProcedureBuilderWithInputOutput<
         z.ZodObject<
            {
               type: z.ZodOptional<
                  z.ZodEnum<{
   ...
   categories: {
      ...
      remove: import("@orpc/contract").ContractProcedureBuilderWithInputOutput<
         ...
         Record<never, never>
      >;
      archive: import("@orpc/contract").ContractProcedureBuilderWithInputOutput<
         z.ZodObject<
            {
               id: z.ZodString;
            },
