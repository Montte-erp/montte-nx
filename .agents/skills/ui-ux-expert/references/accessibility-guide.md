...
```html
<p>
   The French phrase <span lang="fr">bon appétit</span> means enjoy your meal.
</p>
```
...
<!-- ✅ GOOD: Color + text -->
<p class="required"><span aria-label="Required">*</span> Email</p>
...
<div class="status status-active"><span aria-hidden="true">✓</span> Active</div>
...
<div id="password-requirements">Password must be at least 8 characters</div>
```
...
<!-- Off: Not announced -->
<div aria-live="off">This updates frequently but shouldn't interrupt</div>
```
...
```html
<!-- Form validation -->
<span role="alert" aria-live="assertive"> Email is required </span>

<!-- Loading indicator -->
<div role="status" aria-live="polite">Loading results...</div>

<!-- Search results count -->
<div role="status" aria-live="polite" aria-atomic="true">Found 42 results</div>
```
