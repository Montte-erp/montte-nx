   ...
   function ye(e, t) {
      return C(this, null, function* () {
         ...
         const { scale: r = 1, workerUrl: n, workerNumber: i = 1 } = t || {},
            ...
            o =
               (h = e.ownerDocument) != null ? h : U ? window.document : void 0,
            c =
               (p = (g = e.ownerDocument) == null ? void 0 : g.defaultView) !=
               null
                  ? p
                  : U
                    ? window
   ...
   function Ct(e, t) {
      return C(this, null, function* () {
         ...
         if (n) {
            let i = !0;
            if (
               (yield L(r, { onError: () => (i = !1), onWarn: t.log.warn }), !i)
            )
  ...
  `);
   ...
   function ne(e, t, r = !1, n) {
      return C(this, null, function* () {
         ...
         if (i && et(e))
            return (
               n && /\S/.test(e.data) && n(e.data), i.createTextNode(e.data)
            );
         if (i && a && I(e) && (V(e) || H(e))) {
                  ...
                  m
                     .filter((f) => {
                        ...
                        return (
                           ...
                           ((h = we(f.style.getPropertyValue("font-family"))) ==
                           null
                              ? void 0
                              : h.some((g) => i.has(g)))
                        );
