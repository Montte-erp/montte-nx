...
export type { AutomationTemplate, NewAutomationTemplate } from "../schemas/automation-templates";
...
export async function deleteAutomationTemplate(
	...
	try {
		...
		if (existingTemplate.organizationId !== organizationId) {
			throw AppError.forbidden("Cannot delete template from another organization");
		}
