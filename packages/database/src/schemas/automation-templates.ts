...
export const automationTemplate = pgTable(
	"automation_template",
	{
		...
		consequences: jsonb("consequences").$type<Consequence[]>().notNull().default([]),
...
export type AutomationTemplateUsage = typeof automationTemplateUsage.$inferSelect;
export type NewAutomationTemplateUsage = typeof automationTemplateUsage.$inferInsert;
