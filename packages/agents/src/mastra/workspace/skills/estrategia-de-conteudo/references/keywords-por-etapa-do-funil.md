...
Este guia organiza palavras‑chave por estágio do funil.
Use para mapear intenção, priorizar temas e construir séries.

## Visão geral das etapas

- Awareness (descoberta): busca ampla e educativa.
- Consideration (consideração): comparação e alternativas.
- Decision (decisão): preço, prova, compra.
- Implementation (implementação): uso, templates, execução.
...
- Por que a intenção de busca importa?
...
- Conteúdo interno vs terceirizado: o que vale mais?
...
- Teste grátis: o que está incluído?
...
- Modelo de auditoria de conteúdo com pontuação.
...
## Como combinar termos

Combine o tema com o modificador.
...
- “Template de briefing para blog B2B”.
...
Evite misturar estágios no mesmo post.
Se quiser atravessar etapas, crie uma série.
Mantenha consistência com o pilar definido.
