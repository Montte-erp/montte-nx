# Framework Pillar‑Cluster

Este framework organiza o blog em pilares e clusters.
Ele conecta intenção de busca com estrutura editorial.

## 1) Como identificar pilares

Você precisa de 3 a 5 pilares principais.
Eles funcionam como “temas mãe”.
...
### Checklist para validar pilares

- Tem relevância comercial.
- Tem volume e demanda de busca.
- Conecta com o produto.
- Gera ao menos 15 posts derivados.

## 2) Estrutura Pillar → Cluster → Artigos

Pillar Topic (tema principal)
→ Subtopic Clusters (subtemas)
→ Articles (posts específicos)
...
- Link para funil adjacente: “Melhores ferramentas de calendário editorial”.

## 4) Hub & Spoke aplicado ao blog
...
## 7) Como construir um cluster do zero

1. Defina um pilar com clareza.
2. Liste 5 a 8 subtemas do pilar.
3. Para cada subtema, crie 3 a 5 posts.
4. Crie um hub central e conecte todos.
5. Publique em sequência e interlinke tudo.

## 8) Sinais de que o cluster está fraco

- Poucos links entre os posts.
- Posts isolados sem relação clara.
- Dificuldade de crescer tráfego orgânico.
- Baixa retenção do leitor.

## 9) Métricas para acompanhar

- Crescimento de tráfego por pilar.
- CTR das páginas de hub.
- Tempo médio por cluster.
- Número de links internos por post.
- Posição média de keywords do pilar.

## 10) Encerramento

Pillar‑Cluster não é só estrutura.
É uma decisão editorial consciente.
Quando o blog vira rede, cada post impulsiona o outro.
