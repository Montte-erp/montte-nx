...
export const TRIGGER_DEFINITIONS: TriggerDefinition[] = [
   ...
   // Anomaly triggers
   {
      ...
      category: "transaction",
      description:
         "Acionado quando gastos do período estão significativamente acima da média",
   ...
   },
   {
      ...
      category: "transaction",
      description:
         "Acionado quando gastos em uma categoria estão fora do padrão",
      eventDataSchema: ANOMALY_EVENT_DATA_SCHEMA,
   ...
   },
   {
      ...
      category: "transaction",
      description:
         "Acionado quando uma transação de valor muito alto é detectada",
      eventDataSchema: ANOMALY_EVENT_DATA_SCHEMA,
   ...
   // Goal triggers
   {
      ...
      category: "transaction",
      description:
         "Acionado quando uma meta atinge um marco (25%, 50%, 75%, 100%)",
   ...
   },
   {
      ...
      category: "transaction",
      description:
         "Acionado quando uma meta está em risco de não ser atingida no prazo",
      eventDataSchema: GOAL_EVENT_DATA_SCHEMA,
      label: "Meta em Risco",
      supportsSimulation: false,
      type: "goal.at_risk",
