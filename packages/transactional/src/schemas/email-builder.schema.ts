...
export const emailStylesSchema = z.object({
	...
	fontFamily: z.enum(["sans-serif", "serif", "monospace"]).optional().default("sans-serif"),
});
...
export const EMAIL_VARIABLES = [
	{ key: "organization.name", label: "Nome da Organização", category: "organization" },
...
export const DEFAULT_BILLS_DIGEST_TEMPLATE: EmailTemplate = {
	blocks: [
		...
		{ type: "text", content: "Aqui está o resumo das suas contas para o período {{date.period}}:", align: "left" },
		{ type: "spacer", height: 16 },
		{ type: "table", dataSource: "bills_data" },
		{ type: "spacer", height: 24 },
		{ type: "text", content: "Total: {{bills.total}}", align: "right" },
		{ type: "spacer", height: 24 },
		{ type: "button", text: "Ver Todas as Contas", url: "{{app.url}}/bills", align: "center", variant: "primary" },
		{ type: "spacer", height: 16 },
		{ type: "divider" },
		{ type: "spacer", height: 8 },
		{ type: "text", content: "Enviado automaticamente por {{organization.name}}", align: "center" },
	],
	styles: {
		primaryColor: "#3b82f6",
