...
- Enqueue do título acontece dentro da transação Drizzle que persiste a resposta do assistente, usando o adapter transacional do `pg-boss` com o `tx` do Drizzle.
