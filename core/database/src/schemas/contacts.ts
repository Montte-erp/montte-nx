...
export const contactTypeEnum = pgEnum("contact_type", ["cliente", "fornecedor", "ambos"]);

export const contactDocumentTypeEnum = pgEnum("contact_document_type", ["cpf", "cnpj"]);
...
export type ContactDocumentType = (typeof contactDocumentTypeEnum.enumValues)[number];
