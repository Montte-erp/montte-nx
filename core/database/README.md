...
| `./schemas/*`      | Individual table schemas (assets, bills, budgets, categories, credit-cards, dashboards, events, financial-goals, inventory, services, subscriptions, transactions, webhooks, etc.) |
