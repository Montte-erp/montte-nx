...
const TIME_GROUPING_LABELS: Record<
   NonNullable<InsightConfig["timeGrouping"]>,
   string
> = {
   day: "Dia",
   week: "Semana",
...
export function SaveAsInsightCredenza({
   ...
   // Get chart type info
   const chartTypeInfo = CHART_TYPE_CONFIG[config.chartType] || {
            ...
            <div className="space-y-6">
               ...
               <section className="space-y-4">
                  <div className="flex items-center gap-2 pb-2 border-b">
                     ...
                     <h4 className="text-sm font-medium">Configuracao</h4>
                  </div>
                  ...
                  <div className="space-y-3 pl-2">
                     ...
                     {config.comparison && (
                        <ConfigRow
                           ...
                           label="Comparacao"
                           value={
                              COMPARISON_LABELS[config.comparison.type] ||
                     ...
                     {filterCount > 0 && (
                        <div className="flex items-center gap-3 text-sm">
                           ...
                           <Badge className="text-xs" variant="secondary">
                              {filterCount}{" "}
                              {filterCount === 1 ? "filtro" : "filtros"} ativos
                           </Badge>
                        </div>
                     )}
