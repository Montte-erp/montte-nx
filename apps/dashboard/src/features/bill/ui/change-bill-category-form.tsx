		...
		<>
			...
			<div className="px-4 flex-1 overflow-y-auto">
				<div className="space-y-4 py-4">
					...
					<FieldGroup>
						<Field>
							<FieldLabel>{translate("common.form.tags.label")}</FieldLabel>
							{selectedTagIds.length > 0 && (
					...
					<FieldGroup>
						<Field>
							...
							<Combobox
								className="w-full justify-between"
								createLabel={translate("common.form.cost-center.create")}
								disabled={isLoading || isCreating}
								emptyMessage={translate("common.form.search.no-results")}
								...
								placeholder={translate("common.form.cost-center.placeholder")}
								searchPlaceholder={translate("common.form.search.label")}
