...
function ButtonPreview({
	...
	return (
		<div style={{ textAlign: align }} className="my-4">
			<a
				href={url || "#"}
...
function TablePreview() {
	...
	const sampleBills = [
		{ description: "Aluguel", dueDate: "05/01/2026", amount: "R$ 2.500,00", status: "Pendente" },
		{ description: "Internet", dueDate: "10/01/2026", amount: "R$ 150,00", status: "Pendente" },
		{ description: "Energia", dueDate: "15/01/2026", amount: "R$ 280,00", status: "Vencida" },
	];
			...
			<table className="w-full text-sm">
				...
				<tbody>
					{sampleBills.map((bill, index) => (
						<tr key={`bill-${index}`} className="border-t">
