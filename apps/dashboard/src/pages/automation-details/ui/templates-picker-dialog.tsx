...
> = {
   ...
   transaction_processing: {
      label: "Processamento de Transacoes",
      icon: FileText,
   },
                        ...
                        <CommandGroup heading="Templates do Sistema">
                           {Object.entries(templatesByCategory ?? {})
                              ...
                              .map(([category, categoryTemplates]) => {
                                 const categoryMeta =
                                    CATEGORY_META[category as TemplateCategory];
                                 const systemCategoryTemplates =
                                    categoryTemplates?.filter(
                                       (t) => t.isSystemTemplate,
                                    );

                                 if (!systemCategoryTemplates?.length)
                                    return null;

                                 return systemCategoryTemplates.map(
                                    (template) => {
