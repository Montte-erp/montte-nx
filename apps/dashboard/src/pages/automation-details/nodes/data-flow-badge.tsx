...
const BADGE_STYLES = {
	...
	output: "bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-300",
	both: "bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300",
	optional: "bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-300",
} as const;
