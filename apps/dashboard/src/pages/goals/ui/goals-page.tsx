...
function GoalsPageContent() {
	...
	const { typeFilter, setTypeFilter, statusFilter, setStatusFilter } = useGoalList();
	...
	const typeChips = [
		...
		},
		{
			icon: CreditCard,
			label: "Quitar Divida",
			value: "debt_payoff" as const,
		},
		{
			icon: TrendingDown,
			label: "Limite de Gastos",
			value: "spending_limit" as const,
		},
		{
			icon: Wallet,
			label: "Meta de Receita",
			value: "income_target" as const,
		},
	];
			...
			<div className="flex flex-wrap gap-4">
				<div className="flex-1 min-w-0">
					...
					<ToggleGroup
						...
						onValueChange={(value) =>
							setTypeFilter((value || null) as GoalTypeFilter)
						}
						size="sm"
						spacing={2}
						type="single"
