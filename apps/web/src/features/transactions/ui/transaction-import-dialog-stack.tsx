...
function UploadStep({ methods, onFileReady }: UploadStepProps) {
   ...
   return (
      <DialogStackContent index={0}>
         <DialogStackHeader>
            <DialogStackTitle>Importar Lançamentos</DialogStackTitle>
            <DialogStackDescription>
...
function PreviewStep({
   ...
   return (
      <TooltipProvider>
         <DialogStackContent index={0}>
            <DialogStackHeader>
               <DialogStackTitle>Prévia dos Lançamentos</DialogStackTitle>
               <DialogStackDescription>
                     ...
                     {!duplicateCheckDone && (
                        <Tooltip>
                           ...
                           <TooltipContent
                              ...
                              side="left"
                           >
                              Verifica se os lançamentos importados já existem
                              no sistema com base em valor (45%), data (35%) e
                              conta (20%).
                           </TooltipContent>
                        </Tooltip>
                     )}
            ...
            <div className="border-t px-4 py-4">
               <div className="flex gap-2">
                  ...
                  <Button
                     className="flex-1"
                     disabled={
                        visibleRows.length === 0 || !defaults.bankAccountId
                     }
            ...
            <div className="flex flex-col gap-4">
               ...
               {visibleRows.length === 0 && (
                  <div className="flex items-center gap-2 rounded-lg border border-amber-200 bg-amber-50 p-3">
                     ...
                     <p className="text-xs text-amber-700">
                        Não há lançamentos para importar após aplicar os
                        filtros.
                     </p>
                  </div>
               )}
